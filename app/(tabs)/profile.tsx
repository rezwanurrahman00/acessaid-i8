        ...
        <ThemedView style={[styles.infoSection, { backgroundColor: colors.background }]}>
          <View style={styles.infoItem}>
            ...
            {isEditing ? (
              ...
              <ThemedText style={[styles.value, { color: colors.text }]}>{user.name}</ThemedText>
            )}
          </View>

          <View style={styles.infoItem}>
            <ThemedText style={[styles.label, { color: colors.text }]}>Email</ThemedText>
            <ThemedText style={[styles.value, { color: colors.text }]}>{user.email}</ThemedText>
          </View>
          ...
          <View style={styles.infoItem}>
            ...
            {isEditing ? (
              ...
              <ThemedText style={[styles.value, { color: colors.text }]}>{user.age || 'Not provided'}</ThemedText>
            )}
          </View>
          ...
          <View style={styles.infoItem}>
            ...
            {isEditing ? (
              ...
              <ThemedText style={[styles.value, { color: colors.text }]}>{user.height || 'Not provided'}</ThemedText>
            )}
          </View>
          ...
          <View style={styles.infoItem}>
            ...
            {isEditing ? (
              ...
              <ThemedText style={[styles.value, { color: colors.text }]}>{user.weight || 'Not provided'}</ThemedText>
            )}
          </View>

          <View style={styles.infoItem}>
            <ThemedText style={[styles.label, { color: colors.text }]}>Blood Group</ThemedText>
            {isEditing ? (
              <TextInput
                style={[styles.input, { 
                  backgroundColor: colors.background,
              ...
              <ThemedText style={[styles.value, { color: colors.text }]}>{user.bloodGroup || 'Not provided'}</ThemedText>
            )}
          </View>

          <View style={styles.infoItem}>
            <ThemedText style={[styles.label, { color: colors.text }]}>Food Allergies</ThemedText>
            {isEditing ? (
              <TextInput
                style={[styles.input, { 
                  backgroundColor: colors.background,
                ...
                value={editedFoodAllergy}
                onChangeText={setEditedFoodAllergy}
                placeholder="e.g., peanuts, shellfish, dairy"
              />
            ) : (
              <ThemedText style={[styles.value, { color: colors.text }]}>{user.foodAllergy || 'No allergies listed'}</ThemedText>
            )}
          </View>
        </ThemedView>
